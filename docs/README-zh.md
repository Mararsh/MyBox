...
* 改进：                    
     - 编辑图像时，可以设置橡皮檫的显示颜色与绘制颜色。                                                          
* 解决问题：编辑图像，                    
     - 图像的选项未生效。                    
     - 定义多边形范围时，不能正确清除点，且表中直接修改的点无效。                    
     - 修改图像大小时，不能直接设置高度。                    
                   

[此版本关闭的需求/问题列表](http://github.com/Mararsh/MyBox/issues?q=is%3Aissue+is%3Aclosed+milestone%3Av6.9.3)
...
| 平台 | 链接 | 大小 | 运行需要 |
| --- | --- | --- |  --- |
| win | [MyBox-win-jar.zip](https://sourceforge.net/projects/mara-mybox/files/latests/MyBox-win-jar.zip)  | 280MB- | Java 25或更高版本 |
| linux | [MyBox-linux.jar.gz](https://sourceforge.net/projects/mara-mybox/files/latests/MyBox-linux.jar.gz)  | 280MB-  | Java 25或更高版本 |
| mac | [MyBox-mac.jar.gz](https://sourceforge.net/projects/mara-mybox/files/latests/MyBox-mac.jar.gz)  |  280MB-  | Java 25或更高版本 |
...
|      文档名       | 版本    | 修改时间   |                                                                                                                                            英文                                                                                                                                               |                                                                                                                                            中文                                                                                                                                               |
|-------------------|---------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 开发日志          | 6.9.3   | 2026-2-10  | [html](https://mara-mybox.sourceforge.io/mybox_devLogs_en.html)                                                                                                                                                                                                                                 | [html](https://mara-mybox.sourceforge.io/mybox_devLogs_zh.html)                                                                                                                                                                                                                                    |
...
| 功能列表          | 6.9.2   | 2025-12-29 | [html](https://mara-mybox.sourceforge.io/mybox_functions_en.html)                                                                                                                                                                                                                               | [html](https://mara-mybox.sourceforge.io/mybox_functions_zh.html)                                                                                                                                                                                                                                  |
...
| 用户手册-综述        | 6.9.3   | 2026-2-10  | [html](https://mara-mybox.sourceforge.io/guide/en/MyBox-Overview-en/MyBox-Overview-en.html) [PDF](https://mara-mybox.sourceforge.io/guide/MyBox-Overview-en.pdf) [odt](https://mara-mybox.sourceforge.io/guide/MyBox-Overview-en.odt)                     | [html](https://mara-mybox.sourceforge.io/guide/zh/MyBox-Overview-zh/MyBox-Overview-zh.html) [PDF](https://mara-mybox.sourceforge.io/guide/MyBox-Overview-zh.pdf) [odt](https://mara-mybox.sourceforge.io/guide/MyBox-Overview-zh.odt)                     |
...
| 关于-二维存储结构的数据     | 6.9.2   | 2025-12-29    | [html](https://mara-mybox.sourceforge.io/mybox_about_data2d_en.html)                                                                                                                                                                                                                     | [html](https://mara-mybox.sourceforge.io/mybox_about_data2d_zh.html)                                                                                                                                                                                                                                    |
...
| 关于-宏命令   | 6.9.1   | 2025-10-1   | [html](https://mara-mybox.sourceforge.io/mybox_about_macro_en.html)                                                                                                                                                                                                                             | [html](https://mara-mybox.sourceforge.io/mybox_about_macro_zh.html)                                                                                                                                                                                                                                    |
...
| 示例-二维存储结构的数据       | 6.9.2   | 2025-12-29 | [html](https://mara-mybox.sourceforge.io/mybox_examples_data2d_en.html)                                                                                                                                                                                                                          | [html](https://mara-mybox.sourceforge.io/mybox_examples_data2d_cn.html)                                                                                                                                                                                                                                    |
...
| 示例-宏命令   | 6.9.1   | 2025-10-2  | [html](https://mara-mybox.sourceforge.io/mybox_examples_Node_Macro_en.html)                                                                                                                                                                                                                     | [html](https://mara-mybox.sourceforge.io/mybox_examples_Node_Macro_zh.html)                                                                                                                                                                                                                                    |
...
| jpackage | 自包含包 | <https://docs.oracle.com/en/java/javase/25/docs/specs/man/jpackage.html>   |
