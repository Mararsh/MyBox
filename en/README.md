...
<font color=red>Several known bugs cause following tools fail to work: "Modify PDF attributes", "Split PDF", "Compress PDF". If need these functions, please use v5.2 or wait for v5.4.</font>
