...
| 平台 | 链接 | 大小 | 运行需要 |    
| --- | --- | --- |  --- |   
| win | [MyBox-6.4.1-win-jar.zip](https://github.com/Mararsh/MyBox/releases/download/v6.4.1/MyBox-6.4.1-win-jar.zip)  | 159MB | Java 15.0.1或更高版本 |    
| linux | [MyBox-6.4.1-linux-jar.zip](https://github.com/Mararsh/MyBox/releases/download/v6.4.1/MyBox-6.4.1-linux-jar.zip)  | 172MB  | Java 15.0.1或更高版本 |    
| mac | [MyBox-6.4.1-mac-jar.zip](https://github.com/Mararsh/MyBox/releases/download/v6.4.1/MyBox-6.4.1-mac-jar.zip)  |  168MB  | Java 15.0.1或更高版本 |    
