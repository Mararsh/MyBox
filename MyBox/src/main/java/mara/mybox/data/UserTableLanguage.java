...
public class UserTableLanguage extends ResourceBundle {
    ...
    public UserTableLanguage(String name) throws Exception {
        File file = ConfigTools.tableLanguageFile(name);
        if (!file.exists()) {
            items = null;
        }
    ...
    public Object handleGetObject(String key) {
        ...
        if (value == null) {
            value = CommonValues.TableBundleEn.getString(key);
        }
        if (value == null) {
            value = key;
        }
    ...
    public Enumeration<String> getKeys() {
        return CommonValues.TableBundleEn.getKeys();
    }

    @Override
    protected Set<String> handleKeySet() {
        return CommonValues.TableBundleEn.keySet();
    }
}
