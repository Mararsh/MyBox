    ...
    public static String exceptionMessage(MediaException exception) {
        ...
        switch (exception.getType()) {
            ...
            case OPERATION_UNSUPPORTED:
                msg = message(exception.getType().name());
                break;
            default:
                msg = message("PLAYBACK_ERROR");
                break;
        }
        return msg;
    }
