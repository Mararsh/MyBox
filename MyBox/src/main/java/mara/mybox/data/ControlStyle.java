...
public class ControlStyle {
    ...
    public static String RedButtonPath = "buttonsRed/";
    ...
    public static ControlStyle getControlStyle(String id) {
        ...
        switch (id) {
            ...
            case "refButton":
                return new ControlStyle("refButton", getMessage("Ref"), "CTRL+f", "iconRef.png");
            ...
            case "pcxSelect":
                return new ControlStyle("pcxSelect", "", getMessage("PcxComments"), "", "");

            case "previewButton":
                return new ControlStyle("previewButton", getMessage("Preview"), "", "iconPreview.png");
...
//                return new ControlStyle("preAlphaCheck", "", "", "");
    ...
    public static void setTips(Node node) {
        ...
        FxmlControl.quickTooltip(node, new Tooltip(tips));
    }
