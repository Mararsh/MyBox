...
import static mara.mybox.imagefile.ImageGifFile.readBrokenGifFile;
import static mara.mybox.imagefile.ImageGifFile.readBrokenGifFileWithWidth;
        ...
        try {
            ...
            if (!imageInfo.isIsSampled()) {
                if (imageInfo.getBufferedImage() != null) {
                    ...
                    bufferedImage = FxmlImageTools.getBufferedImage(imageInfo.getImage());
                }
            }
                        ...
                        if (types != null) {
                            ...
                            if (!typesValue.isEmpty()) {
                                try {
                                    ...
                                    imageInfo.setColorSpace(ImageColorTools.getColorSpaceName(cs.getType()));
