...
//                    }
            ...
            if (attributes.getDensity() > 0) {
                ...
                String dpm = ImageConvert.dpi2dpm(attributes.getDensity()) + "";
            ...
            if (javax_imageio_png.containsKey("pHYs")) {
                ...
                if (pHYs.containsKey("unitSpecifier")) {
                    ...
                    if (pHYs.containsKey("pixelsPerUnitXAxis")) {
                        ...
                        if (isMeter) {
                            pngInfo.setXDpi(ImageConvert.dpm2dpi(v));  // resolution value should be dpi
                        } else {
                            pngInfo.setXDpi(v);
                        }
//                        logger.debug("pixelsPerUnitXAxis:" + pngInfo.gethResolution());
                    ...
                    if (pHYs.containsKey("pixelsPerUnitYAxis")) {
                        ...
                        if (isMeter) {
                            pngInfo.setYDpi(ImageConvert.dpm2dpi(v));   // resolution value should be dpi
                        } else {
                            pngInfo.setYDpi(v);
                        }
