 ...
 */
public class ImageManufactureWatermarkController extends ImageManufactureController {
    ...
    @FXML
    protected ToolBar watermarkBar;
    @FXML
    ...
    public ImageManufactureWatermarkController() {
