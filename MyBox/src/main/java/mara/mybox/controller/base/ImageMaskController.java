 ...
 */
public abstract class ImageMaskController extends ImageBaseController {

    protected boolean needNotRulers, needNotCoordinates, handleLoadedSize;
    ...
    protected DoublePenLines maskPenData;
    protected List<List<Line>> maskPenLines;

    protected String ImageRulerXKey, ImageRulerYKey, ImagePopCooridnateKey;
