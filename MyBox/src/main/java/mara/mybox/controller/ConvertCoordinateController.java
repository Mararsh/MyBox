...
//                        MyBoxLog.debug(e.toString());
    ...
    public void csConvert() {
        try {
            ...
            names.addAll(Arrays.asList(message("CoordinateSystem"),
                    message("Longitude"), message("Latitude"),
                    message("Longitude") + "-" + message("DegreesMinutesSeconds"),
                    message("Latitude") + "-" + message("DegreesMinutesSeconds")
            ));
            ...
            if (mapbar != null) {
                row = new ArrayList<>();
                row.addAll(Arrays.asList(message("Mapbar"), mapbar[0] + "", mapbar[1] + "",
