 ...
 */
public class WebFindController extends ControlWebBrowserBox {
    ...
    public WebFindController() {
        baseTitle = AppVariables.message("WebFind");
    }
    ...
    public void initControls() {
        try {
            ...
            String saved = AppVariables.getUserConfigValue(baseName + "Font", "1.2em");
            ...
            caseCheck.setSelected(AppVariables.getUserConfigBoolean(baseName + "CaseInsensitive", false));
            caseCheck.selectedProperty().addListener(new ChangeListener<Boolean>() {
                @Override
                public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                    AppVariables.setUserConfigValue(baseName + "CaseInsensitive", caseCheck.isSelected());
                }
            });

            regCheck.setSelected(AppVariables.getUserConfigBoolean(baseName + "RegularExpression", false));
            regCheck.selectedProperty().addListener(new ChangeListener<Boolean>() {
                @Override
                public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                    AppVariables.setUserConfigValue(baseName + "RegularExpression", regCheck.isSelected());
                }
            });

            wrapCheck.setSelected(AppVariables.getUserConfigBoolean(baseName + "WrapAround", false));
            wrapCheck.selectedProperty().addListener(new ChangeListener<Boolean>() {
                @Override
                public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                    AppVariables.setUserConfigValue(baseName + "WrapAround", wrapCheck.isSelected());
                }
            });
    ...
    protected void findString() {
        try {
            ...
            nextButton.setDisable(true);
            lastButton.setDisable(true);
            String findString = HtmlTools.encodeEscape(value);

            String font = findFontSelector.getValue();
            AppVariables.setUserConfigValue(baseName + "Font", font);
