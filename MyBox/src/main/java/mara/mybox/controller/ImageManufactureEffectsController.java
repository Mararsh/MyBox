...
public class ImageManufactureEffectsController extends ImageManufactureOperationController {
    ...
    @FXML
    protected RadioButton ContrastRadio, ClarityRadio, PosterizingRadio, ThresholdingRadio, GrayRadio,
            SepiaRadio, BlackOrWhiteRadio, EdgeDetectionRadio, EmbossRadio, BlurRadio, SharpenRadio, ConvolutionRadio,
    ...
    private void checkEffectType() {
        try {
            ...
            } else if (ClarityRadio.equals(selected)) {
                effectType = OperationType.Clarity;

            } else if (EdgeDetectionRadio.equals(selected)) {
