 ...
 */
public class ImageManufactureBatchWatermarkController extends ImageManufactureBatchController {

    private final String ImageWatermarkShadowKey, ImageFontFamilyKey, ImageWatermarkColorKey;
    ...
    public ImageManufactureBatchWatermarkController() {
