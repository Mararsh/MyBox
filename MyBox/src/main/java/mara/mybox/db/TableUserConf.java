            ...
            if (values != null && !values.isEmpty()) {
                for (String key : values.keySet()) {
                    ...
                    switch (value.toLowerCase()) {
                        case "true":
                            statement.executeUpdate("INSERT INTO User_Conf(key_Name, int_Value) VALUES('" + key + "', 1 )");
                            break;
                        case "false":
                            statement.executeUpdate("INSERT INTO User_Conf(key_Name, int_Value) VALUES('" + key + "', 0 )");
                            break;
                        default:
                            try {
...
//            logger.debug(e.toString());
    ...
    public static int write(String keyName, String stringValue) {
        try (Connection conn = DriverManager.getConnection(protocol + dbName + login);
            ...
            if (results.next()) {
                if (stringValue == null) {
                    sql = "UPDATE User_Conf SET string_Value=NULL WHERE key_Name='" + keyName + "'";
//                    logger.debug(sql);
                    return statement.executeUpdate(sql);
                } else if (!stringValue.equals(results.getString("string_Value"))) {
                    sql = "UPDATE User_Conf SET string_Value='" + stringValue + "' WHERE key_Name='" + keyName + "'";
//                    logger.debug(sql);
                    return statement.executeUpdate(sql);
                } else {
                    return 0;
                ...
                sql = "INSERT INTO User_Conf(key_Name, string_Value) VALUES('" + keyName + "', '" + stringValue + "' )";
//                logger.debug(sql);
                return statement.executeUpdate(sql);
            }
        } catch (Exception e) {
        ...
        try (Connection conn = DriverManager.getConnection(protocol + dbName + login);
            ...
            if (results.next()) {
                if (intValue != results.getInt("int_Value")) {
                    sql = "UPDATE User_Conf SET int_Value=" + intValue + " WHERE key_Name='" + keyName + "'";
//                    logger.debug(sql);
                    return statement.executeUpdate(sql);
                } else {
                    return 0;
                ...
                sql = "INSERT INTO User_Conf(key_Name, int_Value) VALUES('" + keyName + "', " + intValue + " )";
//                logger.debug(sql);
                return statement.executeUpdate(sql);
            }
        } catch (Exception e) {
        ...
        try (Connection conn = DriverManager.getConnection(protocol + dbName + login);
            ...
            if (resultSet.next()) {
                ...
                if (defaultValue != null) {
                    String sql = "INSERT INTO User_Conf(key_Name, string_Value) VALUES('" + keyName + "', '" + defaultValue + "' )";
//                    logger.debug(sql);
    ...
    public static int readInt(String keyName, int defaultValue) {
        try (Connection conn = DriverManager.getConnection(protocol + dbName + login);
            ...
            if (resultSet.next()) {
                ...
                String sql = "INSERT INTO User_Conf(key_Name, int_Value) VALUES('" + keyName + "', " + defaultValue + " )";
//                logger.debug(sql);
                statement.executeUpdate(sql);
                return defaultValue;
            }
...
//            logger.debug(e.toString());
    ...
    public static boolean deleteSuffix(String keyName) {
        if (keyName == null || keyName.isEmpty()) {
            return false;
        }
        try (Connection conn = DriverManager.getConnection(protocol + dbName + login);
    ...
    public static boolean deleteInclude(String keyName) {
        if (keyName == null || keyName.isEmpty()) {
            return false;
        }
        try (Connection conn = DriverManager.getConnection(protocol + dbName + login);
