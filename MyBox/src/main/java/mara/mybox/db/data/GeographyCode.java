...
public class GeographyCode extends BaseData {
        ...
        try {
            switch (column) {
                ...
                case "coordinate_system":
                    ...
                    return true;
                case "area":
                    data.setArea(value == null ? CommonValues.InvalidLong : (long) value);
                    return true;
                case "population":
                    data.setPopulation(value == null ? CommonValues.InvalidLong : (long) value);
                    return true;
                case "code1":
    ...
    public static String displayDataMore(GeographyCode data, String lineBreak) {
        ...
        if (!data.getName().equals(fullname)) {
            return lineBreak + message("FullAddress") + ": " + fullname;
        } else {
            return "";
        }
    }
