        ...
        try {
            switch (column) {
                ...
                case "precision":
                    ...
                    return true;
                case "speed":
                    data.setSpeed(value == null ? CommonValues.InvalidDouble : (Double) value);
                    return true;
                case "direction":
                    data.setDirection(value == null ? CommonValues.InvalidShort : (short) value);
                    return true;
                case "coordinate_system":
                    ...
                    return true;
                case "data_value":
                    data.setDataValue(value == null ? CommonValues.InvalidDouble : (Double) value);
                    return true;
                case "data_size":
                    data.setDataSize(value == null ? CommonValues.InvalidDouble : (Double) value);
                    return true;
                case "start_time":
                    data.setStartTime(value == null ? CommonValues.InvalidLong : (long) value);
                    return true;
                case "end_time":
                    data.setEndTime(value == null ? CommonValues.InvalidLong : (long) value);
                    return true;
                case "location_image":
        ...
        switch (column) {
            ...
            case "coordinate_system":
                return data.getCoordinateSystem() == null
                        ...
                        : data.getCoordinateSystem().intValue();
            case "data_value":
