...
public class FxmlImageManufacture {
    ...
    public static Image scaleImage(Image image, int width, int height,
        ...
        BufferedImage source = SwingFXUtils.fromFXImage(image, null);
        BufferedImage target = ImageManufacture.scaleImage(source, width, height, dither, antiAlias, quality, interpolation);
        Image newImage = SwingFXUtils.toFXImage(target, null);
        return newImage;
    }
    ...
    public static Image scaleImage(Image image, int width, int height,
        ...
        BufferedImage source = SwingFXUtils.fromFXImage(image, null);
        BufferedImage target = ImageManufacture.scaleImage(source, width, height, keepRatio, keepType);
        Image newImage = SwingFXUtils.toFXImage(target, null);
        return newImage;
    }
