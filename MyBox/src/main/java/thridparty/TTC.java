...
//            MyBoxLog.console("seek:" + offsets[index]);
    ...
    public String html() {
        try {
            ...
            String html = "TTC: " + ttcFile.getAbsolutePath() + "<BR>"
                    + message("Tag") + ":" + tag + " "
                    + message("Count") + ":" + ttfCount + "<BR>";

            List<String> names = Arrays.asList("index", message("Offset"), message("Tag"),
            ...
            for (int i = 0; i < ttfInfos.size(); i++) {
                ...
                names = Arrays.asList("index", message("Tag"), "checkSum",
    ...
    public List<File> extract(File targetPath) {
        ...
        String namePrefix = FileTools.namePrefix(ttcFile.getName());
        try ( RandomAccessFile inputStream = new RandomAccessFile(ttcFile, "r")) {
            ...
            for (int i = 0; i < ttfInfos.size(); i++) {
                ...
                if (targetPath != null) {
                    ...
                    ttfFile = FileTools.getTempFile(".ttf");
                }
