    ...
    public static Object getValue(Dataset data, String column) {
        ...
        try {
            switch (column) {
                ...
                case "text_color":
                    return data.getTextColor() == null ? null : FxColorTools.color2rgba(data.getTextColor());
                case "text_background_color":
                    return data.getBgColor() == null ? null : FxColorTools.color2rgba(data.getBgColor());
                case "chart_color":
                    return data.getChartColor() == null ? null : FxColorTools.color2rgba(data.getChartColor());
                case "dataset_image":
