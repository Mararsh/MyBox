...
[Closed requirements/bugs in this version](http://github.com/Mararsh/MyBox/issues?q=is%3Aissue+is%3Aclosed+milestone%3Av6.6.3)             
...
### Source Codes
[MyBox-6.6.3-src.zip](https://sourceforge.net/projects/mara-mybox/files/v6.6.3/MyBox-6.6.3-src.zip)   55MB-        
...
| --- | --- | ---  | ---  |
| win10 x64 | [MyBox-6.6.3-win-x64.zip](https://sourceforge.net/projects/mara-mybox/files/v6.6.3/MyBox-6.6.3-win10-x64.zip)  | 260MB- | MyBox.exe |
| CentOS 7 x64 | [MyBox-6.6.3-CentOS7-x64.tar.gz](https://sourceforge.net/projects/mara-mybox/files/v6.6.3/MyBox-6.6.3-CentOS7-x64.tar.gz)  | 280MB-  | bin/MyBox  |
| mac | [MyBox-6.6.3-mac.dmg](https://sourceforge.net/projects/mara-mybox/files/v6.6.3/MyBox-6.6.3-mac.dmg)  | 280MB-  |  MyBox-6.6.3.app   |        
...
| --- | --- | ---  | ---  |
| win | [MyBox-6.6.3-win-jar.zip](https://sourceforge.net/projects/mara-mybox/files/v6.6.3/MyBox-6.6.3-win-jar.zip)  | 190MB- | Java 18 or higher |
| linux | [MyBox-6.6.3-linux-jar.zip](https://sourceforge.net/projects/mara-mybox/files/v6.6.3/MyBox-6.6.3-linux-jar.zip)  | 200MB-  | Java 18 or higher |
| mac | [MyBox-6.6.3-mac-jar.zip](https://sourceforge.net/projects/mara-mybox/files/v6.6.3/MyBox-6.6.3-mac-jar.zip)  |  200MB-  | Java 18 or higher |        


Run following command to launch this program with Jar package:        
<PRE><CODE>     java   -jar   MyBox-6.6.3.jar</CODE></PRE>        

A file path can follow the command as argument to be opened directly by MyBox. Example, following command will open the image:        
<PRE><CODE>     java   -jar   MyBox-6.6.3.jar   /tmp/a1.jpg</CODE></PRE>        
...
| --- | --- |
| win | `C:\users\UserName\mybox\MyBox_v6.6.3.ini`  |
| linux | `/home/UserName/mybox/MyBox_v6.6.3.ini` |
| mac | `/Users/UserName/mybox/MyBox_v6.6.3.ini` |        
