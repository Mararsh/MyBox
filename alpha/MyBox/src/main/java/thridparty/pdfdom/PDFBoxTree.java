 ...
 * document and calls the appropriate abstract methods in order to render a
 * page, text box, etc. The particular implementations are expected to implement
...
public abstract class PDFBoxTree extends PDFTextStripper {
    ...
    /**
     * When set to <code>true</code>, the graphics in the PDF file will be
     * ignored.
     */
    ...
    /**
     * When set to <code>true</code>, the image data will not be transferred to
     * the HTML data: url.
     */
    ...
    /**
     * Current text coordinates (the coordinates of the last encountered text
     * box).
     */
     ...
     *
     * @param disableGraphics when set to <code>true</code> the graphics is
     * ignored in the source file.
     */
     ...
     *
     * @return <code>true</code> when the processing of embedded images is
     ...
     *
     * @param disableImages when set to <code>true</code> the images are ignored
     * in the source file.
     */
     ...
     *
     * @return <code>true</code> when the copying of image data is disabled in
     ...
     *
     * @param disableImageData when set to <code>true</code> the image data is
     * not copied to the document tree. The eventual <code>img</code> elements
     * will have an empty <code>src</code> attribute.
     */
     ...
     * text are contained in the {@link PDFBoxTree#curstyle} property.
     *
