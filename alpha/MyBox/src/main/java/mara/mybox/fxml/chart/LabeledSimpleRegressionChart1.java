 ...
 */
public class LabeledSimpleRegressionChart1<X, Y> extends LabeledScatterChart<X, Y> {
    ...
    public LabeledSimpleRegressionChart1(Axis xAxis, Axis yAxis) {
        super(xAxis, yAxis);
        init();
    ...
    /*
        get/set
     */
    public LabeledSimpleRegressionChart1<X, Y> setModel(String model) {
        this.model = model;
        return this;
    }

    public LabeledSimpleRegressionChart1<X, Y> setDisplayFittedPoints(boolean displayFittedPoints) {
        this.displayFittedPoints = displayFittedPoints;
        return this;
    }

    public LabeledSimpleRegressionChart1<X, Y> setDisplayConfidenceLowerPoints(boolean displayConfidenceLowerPoints) {
        this.displayConfidenceLowerPoints = displayConfidenceLowerPoints;
        return this;
    }

    public LabeledSimpleRegressionChart1<X, Y> setDisplayConfidenceUpperPoints(boolean displayConfidenceUpperPoints) {
        this.displayConfidenceUpperPoints = displayConfidenceUpperPoints;
        return this;
    }

    public LabeledSimpleRegressionChart1<X, Y> setDisplayFittedLine(boolean displayFittedLine) {
        this.displayFittedLine = displayFittedLine;
        return this;
    }

    public LabeledSimpleRegressionChart1<X, Y> setDisplayConfidenceLowerLine(boolean displayConfidenceLowerLine) {
        this.displayConfidenceLowerLine = displayConfidenceLowerLine;
        return this;
    }

    public LabeledSimpleRegressionChart1<X, Y> setDisplayConfidenceUpperLine(boolean displayConfidenceUpperLine) {
        this.displayConfidenceUpperLine = displayConfidenceUpperLine;
        return this;
    }

    public LabeledSimpleRegressionChart1<X, Y> setDisplayText(boolean displayText) {
