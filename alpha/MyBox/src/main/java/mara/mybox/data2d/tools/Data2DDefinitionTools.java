...
public class Data2DDefinitionTools {
    ...
    public static String definitionToHtml(Data2D data2d) {
        try {
            ...
            names.addAll(Arrays.asList(message("ColumnName"), message("Type"), message("Length"),
                    message("Width"), message("DisplayFormat"), message("NotNull"), message("Editable"),
                    message("PrimaryKey"), message("AutoGenerated"), message("DefaultValue"), message("Color"),
                    message("ToInvalidValue"), message("DecimalScale"),
                    message("Century"), message("FixTwoDigitYears"), message("Description")));
        ...
        try {
            ...
            if (columns != null) {
                for (Data2DColumn col : columns) {
                    ...
                    if (ColumnDefinition.ColumnType.String == col.getType()) {
                    ...
                    if (col.getFormat() != null) {
                        ...
                        if (ColumnDefinition.ColumnType.Enumeration == col.getType()) {
            ...
            try (CSVPrinter csvPrinter = new CSVPrinter(new FileWriter(tmpFile, Charset.forName("UTF-8")), CsvTools.csvFormat(",", true))) {
                ...
                if (columns != null) {
                    for (Data2DColumn col : columns) {
                        ...
                        row.add(ColumnDefinition.ColumnType.String == col.getType() ? col.getLength() + "" : "");
            ...
            try (XSSFWorkbook xssfBook = new XSSFWorkbook()) {
                ...
                if (columns != null) {
                    for (Data2DColumn col : columns) {
                        ...
                        columnRow.createCell(cellIndex++).setCellValue(ColumnDefinition.ColumnType.String == col.getType() ? col.getLength() + "" : "");
