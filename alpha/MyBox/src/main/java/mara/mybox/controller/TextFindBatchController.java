...
public class TextFindBatchController extends TextReplaceBatchController {
    ...
    @FXML
    protected TextFindBatchOptions findOptionsController;
    @FXML
    ...
    public void initValues() {
        try {
            ...
            optionsController = findOptionsController;
    ...
    public String handleFile(File srcFile, File targetPath) {
        try {
            TextEditInformation info = info(srcFile);
            if (info == null) {
            ...
            updateLogs(message("Found") + ": " + count);
            if (csvPrinter != null) {
