 ...
 */
public class ControlData2DColumnsSource extends ControlData2DColumns {
    ...
    @FXML
    protected TableColumn<Data2DColumn, Boolean> primaryColumn, autoColumn;

    public ControlData2DColumnsSource() {
    }
