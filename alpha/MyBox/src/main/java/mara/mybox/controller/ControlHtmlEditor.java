 ...
 */
public class ControlHtmlEditor extends ControlWebBrowserBox {
    ...
    @FXML
    protected Label viewLabel, codesLabel, editorLabel, markdownLabel, textsLabel;
    @FXML
