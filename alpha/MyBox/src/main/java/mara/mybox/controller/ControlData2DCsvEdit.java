 ...
 */
public class ControlData2DCsvEdit extends BaseController {
    ...
    /*
        static
     */
    public static ControlData2DCsvEdit open(BaseData2DLoadController tableController) {
        try {
            ControlData2DCsvEdit controller = (ControlData2DCsvEdit) WindowTools.branchStage(
