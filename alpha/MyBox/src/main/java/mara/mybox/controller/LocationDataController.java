        ...
        synchronized (this) {
            ...
            task = new SingletonTask<Void>(this) {
                ...
                protected void whenSucceeded() {
                    ...
                    mapController.sequenceRadio.setSelected(true);
                    ...
                    mapController.mapOptionsController.currentQueryRadio.setSelected(true);
                    mapController.mapOptionsController.dataMaximumSelector.getSelectionModel().select("300");
                    mapController.mapOptionsController.markerDatasetRadio.setSelected(true);
                    ...
                    mapController.mapOptionsController.dataColorRadio.setSelected(true);
        ...
        synchronized (this) {
            ...
            task = new SingletonTask<Void>(this) {
                ...
                protected void whenSucceeded() {
                    ...
                    timeController.selectAllAction();
                    mapController.isSettingValues = true;
                    mapController.distributionRadio.setSelected(true);
                    mapController.mapOptionsController.isSettingValues = true;
                    mapController.mapOptionsController.currentQueryRadio.setSelected(true);
