 ...
 */
public class ControlData2DCsvView extends ControlData2DHtml {
    ...
    /*
        static
     */
    public static ControlData2DCsvView open(BaseData2DLoadController tableController) {
        try {
            ControlData2DCsvView controller = (ControlData2DCsvView) WindowTools.branchStage(
