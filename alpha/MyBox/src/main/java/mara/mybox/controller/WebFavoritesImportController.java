...
public class WebFavoritesImportController extends BaseBatchFileController {
    ...
    public WebFavoritesImportController() {
        baseTitle = Languages.message("ImportWebFavorites");
    }
    ...
    public boolean makeMoreParameters() {
        ...
        rootNode = tableTree.findAndCreateRoot(Languages.message("WebFavorites"));
            ...
            while (true) {
                ...
                try {
                    ...
                    if (icon == null || icon.isBlank()) {
                        File iconFile = IconTools.readIcon(address, iconCheck.isSelected());
    ...
    public void donePost() {
        if (favoritesController != null) {
            ...
            favoritesController.alertInformation(Languages.message("Imported") + ": " + totalItemsHandled);
            closeStage();
        } else {
            tableView.refresh();
