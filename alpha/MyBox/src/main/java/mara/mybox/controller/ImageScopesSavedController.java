...
public class ImageScopesSavedController extends BaseSysTableController<ImageScope> {
    ...
    public void setParameters(ControlSelectPixels controller) {
        try {
            ...
            baseName = scopeController.baseName;
            baseTitle = scopeController.baseTitle;
            sourceFile = scopeController.sourceFile;
    ...
    public void useScope() {
        ...
        scopeController.loadScope(selected);
        close();
    }
