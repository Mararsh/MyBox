 ...
 */
public class ImageManufactureHistoriesController extends BaseTableViewController<ImageEditHistory> {
    ...
    /*
        static
     */
    public static ImageManufactureHistoriesController open(ImageManufactureController parent) {
        try {
            ImageManufactureHistoriesController controller = (ImageManufactureHistoriesController) WindowTools.openChildStage(
                    parent.getMyWindow(), Fxmls.ImageManufactureHistoriesFxml, false);
    ...
    public static void updateList(File file) {
        try {
            ...
            for (Window window : windows) {
                ...
                if (object == null || !(object instanceof ImageManufactureHistoriesController)) {
                    continue;
                }
                try {
                    ImageManufactureHistoriesController controller = (ImageManufactureHistoriesController) object;
