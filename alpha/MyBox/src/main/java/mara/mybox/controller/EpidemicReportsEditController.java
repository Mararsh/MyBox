...
public class EpidemicReportsEditController extends BaseDataTableController<EpidemicReport> {
    ...
    public void load(EpidemicReportsController reportsController, boolean isChineseProvince) {
        ...
        if (isChineseProvince) {
            titleLabel.setText(Languages.message("ChineseProvincesEpidemicReports"));
            locationColumn.setText(Languages.message("Province"));
        } else {
            titleLabel.setText(Languages.message("CountriesEpidemicReports"));
            locationColumn.setText(Languages.message("Country"));
        }
        synchronized (this) {
            ...
            task = new SingletonTask<Void>() {
                ...
                protected void whenSucceeded() {
                    ...
                    if (saveCloseCheck.isSelected()) {
                        ...
                        popInformation(Languages.message("Written") + ": " + count);
                    }
                }
            };
            start(task);
