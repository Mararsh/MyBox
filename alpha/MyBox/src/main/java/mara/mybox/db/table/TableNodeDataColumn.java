...
public class TableNodeDataColumn extends BaseNodeTable {
    ...
    public final TableNodeDataColumn defineColumns() {
        defineNodeColumns();
        addColumn(new ColumnDefinition("column_name", ColumnType.String).setLength(StringMaxLength));
        ...
        addColumn(new ColumnDefinition("default_value", ColumnType.String).setLength(StringMaxLength));
    ...
    public String label(String name) {
        ...
        switch (name) {
            case "column_type":
                return message("Type");
            case "column_name":
                return message("ColumnName");
            case "length":
                return message("Length");
            case "width":
                return message("Width");
            case "scale":
                return message("DecimalScale");
            case "color":
            ...
            case "century":
                return message("Century");
            case "format":
                return message("DisplayFormat");
            case "default_value":
