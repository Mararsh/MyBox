...
public class EpidemicReport extends BaseData {
    ...
    public static short sourceValue(String lang, String source) {
        if (Languages.message(lang, "PredefinedData").equals(source) || "PredefinedData".equals(source)) {
            return 1;
        } else if (Languages.message(lang, "InputtedData").equals(source) || "InputtedData".equals(source)) {
            return 2;
        } else if (Languages.message(lang, "FilledData").equals(source) || "FilledData".equals(source)) {
            return 3;
        } else if (Languages.message(lang, "StatisticData").equals(source) || "StatisticData".equals(source)) {
            return 4;
        } else {
            return 0;
        }
...
//        }
    ...
    public String getSourceName() {
        ...
        return Languages.message(sourceName);
    }
